...
export default function Step2(props) {
    ...
    const formatLocation = location.replace(/ /g, "%20")
    const formatLocation2 = formatLocation.replace(/,/g, "%2C")
    ...
    return (
        <div style={{ display: step !== 2 ? 'none' : 'inherit' }}>
            ...
            <iframe src={`https://relive.pt/submit/?title=${formatTitle}_${ID}&note=Propriedade%20${formatTitle}%20submetida%20por%20${formatSe}%20com%20ID%20PRE-${ID}&location=${formatLocation2}&coordinates=${formatCoordinates}`} loading="lazy" style={{ width: '100%', borderWidth: 'inherit', height: '1000px' }} title="Submeter Propriedade Relive">
            </iframe>
            <Grid container>
